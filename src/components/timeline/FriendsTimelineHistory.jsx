    ...
    return (
        <div className='grid grid-cols-3 gap-5'>
            <button
                ...
                className='bg-[#F8FAFC] p-5 rounded-md flex flex-col gap-2 items-center justify-center cursor-pointer transition-transform duration-300 ease-in-out hover:scale-105'>
